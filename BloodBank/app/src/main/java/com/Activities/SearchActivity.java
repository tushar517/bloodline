...
public class SearchActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final EditText et_blood_group, et_city,et_area;
    ...
    submit_button.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if(isValid(blood_group, city,area)){
          get_search_results(blood_group, city,area);
        }
      }
    });
  }
  ...
  private void get_search_results(final String blood_group, final String city,final String area) {
  ...
  private boolean isValid(String blood_group, String city,String area){
