...
import com.Adapters.SearchAdapter;
...
public class SearchResults extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String str;
    if(area!=null)
    str = "Donors in " + city + " in "+area+" with blood group " + blood_group;
    else
      str="Donors in " + city +" with blood group " + blood_group;
    heading.setText(str);
    Gson gson = new Gson();
    ...
    if (dataModels != null && dataModels.isEmpty()) {
      heading.setText("No results Search donors in different area or leave the area blank");
