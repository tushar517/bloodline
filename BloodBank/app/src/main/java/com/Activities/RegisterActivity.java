...
public class RegisterActivity extends AppCompatActivity {
  private EditText nameEt, cityEt,areaEt, bloodGroupEt, passwordEt, mobileEt;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    submitButton.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        String name, city,area, blood_group, password, mobile;
        ...
        if (isValid(name, city,area, blood_group, password, mobile)) {
          register(name, city,area, blood_group, password, mobile);
        }
      }
    });
  }
  private void register(final String name, final String city, final String area,final String blood_group, final String password,
      final String mobile) {
  ...
  private boolean isValid( String name, String city, String area,String blood_group, String password,
                          String mobile) {
