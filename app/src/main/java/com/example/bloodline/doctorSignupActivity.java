...
public class doctorSignupActivity extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isValid(name, city, password, mobile,email)) {
                    mfirebaseauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(doctorSignupActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(doctorSignupActivity.this,"Signup Unsuccessful",Toast.LENGTH_SHORT).show();
                            }
                            else{
                                userid=mfirebaseauth.getCurrentUser().getUid();
                                DocumentReference documentReference= db.collection("users").document(userid);
                                Map<String,Object> users=new HashMap<>();
                                users.put("user_type","Doctor");
                                users.put("Name",name);
                                users.put("city",city);
                                ...
                                documentReference.set(users).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        startActivity(new Intent(doctorSignupActivity.this,home.class));
                                    }
                                });
                    ...
                    Toast.makeText(doctorSignupActivity.this,"sign up unsuccessful ",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private boolean isValid(String name, String city, String password,
        ...
        {
            Toast.makeText(doctorSignupActivity.this,"multiple are empty",Toast.LENGTH_SHORT).show();
        }
